...
<form id="submitform" class="validated-form question-form form-with-upload  hinted-form" action='${uri}' method="post" autocomplete="off">
	...
	<tags:moratab placeholder="${descriptionPlaceholder}" value="${question.description}"
